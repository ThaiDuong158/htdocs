                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="upload.php" method="post" enctype="multipart/form-data" id="upload-form">
                                                ...
                                                <input type="file" style="display: none;" id="image-upload" name="image">
                                                <button type="button" class="btn btn-primary" id="upload-btn">Chọn ảnh</button>
                                                <button type="submit" class="btn btn-primary" name="guithongtin">Lưu ảnh</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
